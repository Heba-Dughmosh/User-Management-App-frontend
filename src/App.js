...
function App() {
  ...
  return (
    <div className="App">
	  ...
	  <button className="addUserBtn" onClick={handleAddUsera}>Add User</button>
        ...
        {isAddingUser && (
            <form>
              ...
              <div className="row">
                ...
                <input type="text" value={formUsername} onChange={handleFormUsername} id="username"/>
              </div>
              ...
              <div className="formButtonArea">
                <button onClick={e => handleFormSaveButton(e)}>Save</button>
              ...
              <div className="row">
                ...
                {user.isEditingEmail && (
                  <div className="data-editing">
                    <input type="text" onChange={(e) => handleEmailChange(user, e)} value={user.email}/>
